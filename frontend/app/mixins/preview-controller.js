    ...
    save: function() {
      ...
      switch(orderType.label) {
        case 'photocopy':
          ...
          order['article_identifier'] = this.get('applicationController.orderDetailsArticle.resolvedArticleIdentifer');
          order['article_identifier_source'] = this.get('applicationController.orderDetailsArticle.resolvedArticleIdentiferSource');
          break;
        case 'loan':
          setOrderProperties([
            'authors',
